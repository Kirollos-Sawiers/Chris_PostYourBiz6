...
//                 <h2 className="text-3xl font-bold">Pie and Thighs</h2>
//                 <FontAwesomeIcon
...
//                     icon={faLocationDot}
//                   />
//                   <span class="text-lg text-gray-700 ml-1 mt-1">Ontario</span>
//                 </div>
//                 <div class="flex items-center text-gray-400">
//                   <FontAwesomeIcon
//                     className="w-4 h-4 text-blue-500"
//                     icon={faDollarSign}
//                   />
//                   <span class="text-lg text-gray-700 ml-1 mt-1">40.000</span>
//                 </div>
//               </div>
//             </div>
//           </div>
